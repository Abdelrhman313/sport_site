...
window.onscroll = () => {
	...
	document.querySelector('.landing-page .header-area .links.open').style.top = 51;
	document.querySelector('.header-toggler.opened::before').style.top = 28;
	...
	document.querySelector('.landing-page .header-area .links.open').style.top = 65;
	document.querySelector('.header-toggler.opened::before').style.top = 33;
    }
}
